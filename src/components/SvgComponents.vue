...
<script>
import Cleaner from "@/components/svgCpt/Cleaner";
import Port from "@/components/svgCpt/Port";
import Cut from "@/components/svgCpt/Cut";
//发电站
export default {
    props: ['height','color','width','type','fontSize','tableData','svgText','editable', 'strokeColor'],
    components: {
      Cut,
      Port,
      Cleaner
